...
yearly_acc_MT = np.array([18.965, 21.075, 20.677, 20.305, 18.917])*1000



years_MT = [2016, 2017, 2018, 2019, 2020]
x_axis = np.arange(len(yearly_acc_MT))


# Plotting with seaborn
fig, ax = plt.subplots(figsize=(5.5, 5))
# sns.lineplot(data=df, x='year', y='acc_count', marker='o', linewidth=1)
ax.plot(x_axis, yearly_acc_MT, lw=3, color='royalblue')
ax.scatter(x_axis, yearly_acc_MT, marker='o', s=150, color='royalblue')
...
ax.set_title(r'$\mathrm{Montana}$', fontsize=36, x=0.55, y=1.0)
