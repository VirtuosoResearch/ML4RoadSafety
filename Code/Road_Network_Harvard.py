...
print("\tCities")
node_df, edge_df = concat_files_one_subfolder(path_stats + "Harvard Dataverse/24-" + state_name + "-cities-street_networks-node_edge_lists/")
...
print("\tCounties")
node_df, edge_df = concat_files_one_subfolder(path_stats + "Harvard Dataverse/24-" + state_name + "-counties-street_networks-node_edge_lists/")
...
print("\tNeighborhoods")
node_df, edge_df = concat_files_two_subfolder(path_stats + "Harvard Dataverse/24-" + state_name + "-neighborhoods-street_networks-node_edge_lists/")
...
print("\tTracts")
node_df, edge_df = concat_files_one_subfolder(path_stats + "Harvard Dataverse/24-" + state_name + "-tracts-street_networks-node_edge_lists/")
...
node_df, edge_df = concat_files_one_subfolder(path_stats + "Harvard Dataverse/24-" + state_name + "-urbanized_areas-street_networks-node_edge_lists/")
...
print("\tNodes")
df_nodes = pd.read_csv(path_stats + "Road_Network_Nodes_" + state_name + ".csv")
