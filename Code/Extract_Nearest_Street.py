...
nodes_df = pd.read_csv(path + "/Road_Networks/" + state_name + "/Road_Network_Nodes_" + state_name + ".csv")
edges_df = pd.read_csv(path + "/Road_Networks/" + state_name + "/Road_Network_Edges_" + state_name + ".csv")

# Accident Data
df = pd.read_csv(path + "/Accidents/" + state_name + "/" + state_name + "_crash.csv")
...
print(f"Extract Nearest Street - {int(df.shape[0]/10000) + 1} files:")


df["node_1"] = 0
df["node_2"] = 0
for j in range(0,int(df.shape[0]/10000)):
    print(f"**** {j} ****")
...
dummy.to_csv(path + "/Accidents/" + state_name + "/Nearest_Street/Accidents_Nearest_Street_" + state_name + "_" + str(j+1) + ".csv",index=False)
